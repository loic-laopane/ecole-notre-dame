...
export default function Page() {
  return (
    <PageLayout>
      <PageHero title="Pastorale" subtitle="La vie spirituelle au Collège et Lycée Notre-Dame" breadcrumbs={[{ label: "Pastorale" }]} />
      <section className="py-16 bg-white">
        <div className="max-w-[860px] mx-auto px-8">
          <div className="bg-cream rounded-xl p-8 border border-border text-center">
            <span className="text-5xl">✝️</span>
            <h2 className="font-display text-2xl text-navy mt-4 mb-2">Pastorale</h2>
