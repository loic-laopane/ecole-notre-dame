      ...
      <div className="max-w-[1200px] mx-auto px-8
        ...
        <div>
          <span className="inline-flex items-center gap-1 text-gold2 text-[.7rem] font-semibold
            ...
            <span className="block w-[18px] h-[1.5px] bg-gold2" />
            Agenda complet
          </span>
            ...
            return (
              <div key={ev.id}
                ...
                <div className="w-[50px] text-center flex-shrink-0">
                  ...
                  <div className="text-[.62rem] text-white/50 uppercase tracking-[.08em]">{mois}</div>
                </div>
                ...
                {ev.type && (
                  <span className="bg-gold/15 border border-gold/30 text-gold
                                   ...
                                   rounded-full uppercase tracking-[.06em] whitespace-nowrap">
                    {ev.type}
                  </span>
                )}
              </div>
